sap.ui.define([
	...
	"com/espedia/demo/JobsScheduler/controller/CameraController",
	"sap/m/MessageBox",
	"com/espedia/demo/JobsScheduler/controller/utils/SearchHelp"
], function (Controller, CameraController, MessageBox, SearchHelp) {
	"use strict";
	////////////////////////////////////////////////////
	// Aggiungo questo file come base per spostare qui alcune funzionalità secondarie come formattazione e Search Help
	// 

	return CameraController.extend("com.espedia.demo.JobsScheduler.controller.BaseController", {
		onInit: function () {
